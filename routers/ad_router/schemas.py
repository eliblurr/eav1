...
class CreateAd(AdBase):
    ...
    @classmethod
    def as_form(cls, title: str = Form(None), metatitle: str = Form(None), description: str = Form(None), status: bool=Form(None), style_id:List[int]=Form(None), location_ids:List[int]=Form(None)):
